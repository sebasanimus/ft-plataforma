<div class="content">
	<form action="iniciativas/perfiles/seleccionSaving" method="POST" id="formPpal" enctype="multipart/form-data">
					...
					<div class="stepsLineBox pb-4">
						<div class="stepsLine">
							<div class="stepBox step1">
								...
								<span class="stepTxt"><?=$textos['paso_1_seleccion']?></span>
							</div>
						</div>
					</div>
				...
				<div class="col-md-12">               
			   		<div class="card ">
						<div class="card-header card-header-rose card-header-text">
							<div class="card-text">
								<h4 class="card-title"><?=$textos['paso_1_seleccion']?></h4>
							</div>
						</div>
				 		<div class="card-body ">
						 	<div class="row">
								<div  id="adjuntoArea1">
									<span class="adentro sinarchivo" style="<?=empty($perfil['adjunto_seleccion'])?'':'display:none'?>">
										Suelte aquí el archivo con la propuesta (word)
									</span>
									<span class="adentro conarchivo" style="<?=empty($perfil['adjunto_seleccion'])?'display:none':''?>">
										<a target="_blank" href="<?=base_url()?>iniciativas/perfiles/descargarSeleccion/<?=$perfil['idperfil']?>"><i class="material-icons">description</i> <span id="archivoNombre1"><?=$perfil['adjunto_seleccion']?></a></span>
									</span>
								</div>
									...
									<div class="fileinput fileinput-new" id="fileinputAdjunto1" data-provides="fileinput">										
										<div>
											<span class="btn btn-outline-secondary btn-file">
												<span class="fileinput-new"><?=empty($perfil['adjunto_seleccion'])?'Seleccionar':'Cambiar'?> Archivo</span>
												<span class="fileinput-exists">Cambiar Archivo</span>
												<input type="file" name="adjuntofile" id="adjuntofile1" style="z-index:200">
												<input type="hidden" name="adjunto_seleccion" value="<?=$perfil['adjunto_seleccion']?>">
											</span>
										</div>
									</div>                                
								</div>
				...
				<div class="col-md-9 col-lg-9 col-xl-7 col-12 mr-auto ml-auto">
					<div class="card card-profile" id="paso10_exito">
						...
						<div class="card-body">
							...
							<p class="card-description"><?=nl2br($textos['submit_descripcion_exito_sel'])?></p>	
						</div>
					</div>
					...
					<div class="card card-profile" id="paso10_error">
						...
						<div class="card-body">
							...
							<p class="card-description"><?=nl2br($textos['submit_descripcion_error_sel'])?></p>							
						</div>
					</div>	
