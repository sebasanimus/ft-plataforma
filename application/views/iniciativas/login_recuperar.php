							...
							<div class="card card-login card-hidden">
								...
								<div class="card-body">									
									<div class="input-group" style="margin: 0 25px">
										<p><?=$textos['recuperar_exito_final']?></p>
									</div>									
								</div>
								<?else:?>
								<div class="card-body">
									...
									<?endif;?>
									<div class="input-group" style="margin: 0 25px">
										<p><?=$textos['recuperar_ingrese_nuevo']?> </p>
									</div>
									...
									<span class="bmd-form-group">
										<div class="input-group">
											...
											<input type="password" name="password" class="form-control" placeholder="<?=$textos['recuperar_nuevo']?>" required>
										</div>
									</span>
								</div>
