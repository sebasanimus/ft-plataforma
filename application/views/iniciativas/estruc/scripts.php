...
<?php
	if(isset($libs)){
        foreach($libs as $lib){
            if (file_exists(APPPATH."views/iniciativas/headscripts/lib_{$lib}_scripts.php")){
                $this->load->view("iniciativas/headscripts/lib_{$lib}_scripts.php");
            }
        }
    }
    if (isset($page) && file_exists(APPPATH."views/iniciativas/headscripts/{$page}_scripts.php")){
        $this->load->view('iniciativas/headscripts/'.$page.'_scripts');
	}
?>
