...
<script>
	...
	$(function() {
		...
		let dropArea2 = document.getElementById('adjuntoArea2');
		...
		function handleDrop2(e) {
			let fileInput = document.getElementById('adjuntofile2');
			fileInput.files = e.dataTransfer.files;
			amanopla(e.dataTransfer.files, e.dataTransfer.files[0], 2);
			agregarAdjunto(2);
		}
		...
		$('#adjuntofile2').on("change", function(){ agregarAdjunto(2); });
	});
        ...
        success: function (data) {
			...
			if(data!='' && !data.startsWith('ok') ){
				...
				if(dividido.length>1){	
					if(num==1){
						$('input[name="adjunto_pre_propuesta"]').val(dividido[1]);
						$('input[name="adjunto_pre_propuesta"]').trigger("change");
					}else{
						$('input[name="adjunto_pre_presupuesto"]').val(dividido[1]);
						$('input[name="adjunto_pre_presupuesto"]').trigger("change");
					}						
