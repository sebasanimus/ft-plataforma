        	...
        	<div class="col-md-12">
				<div class="card ">
					<div class="card-header card-header-rose card-header-icon">
						...
						<h4 class="card-title"><?=(!empty($indicastandar))?'Modificar':'Crear'?> Indicador</h4>
                	...
                	<div class="card-body ">
						<div class="nav-item dropdown opciones-toolbar" style="">	
							...
							<div class="dropdown-menu">
								<a class="dropdown-item dropdown-item-rose" href="admin/indicastandares/listar">Listar Indicadores</a>
							</div>
						</div>
						...
						<form id="form" data-parsley-validate class="form-horizontal" method="POST" enctype="multipart/form-data">
							...
							<fieldset <?=$disabled?> >
								...
								<div class="row">
									<label class="col-sm-2 col-form-label" for="componente">Componente <span class="required">*</span></label>
									<div class="col-sm-10">
										<div class="form-group">
											<select class="form-control" name="componente" id="componente" required="required" >
												<option value="">Elegir</option>
												<? foreach($componentes as $com): ?>
													<option value="<?=$com['value']?>" <?=(!empty($indicastandar) && $indicastandar['componente']==$com['label'])?'SELECTED':''?> ><?=$com['label']?></option>
												<? endforeach;?>                          
											</select>
										</div>
									</div>
