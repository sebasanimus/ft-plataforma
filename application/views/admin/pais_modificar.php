        	...
        	<div class="col-md-12">
				<div class="card ">
					<div class="card-header card-header-rose card-header-icon">
						...
						<h4 class="card-title"><?=(!empty($pais))?'Modificar':'Crear'?> País</h4>
                	...
                	<div class="card-body ">
						<div class="nav-item dropdown opciones-toolbar" style="">	
							...
							<div class="dropdown-menu">
								<a class="dropdown-item dropdown-item-rose" href="admin/paises/listar">Listar Países</a>
							</div>
						</div>
						...
						<form id="form" data-parsley-validate class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
							...
							<fieldset <?=$disabled?> >
								...
								<? input_text('text', $pais, 'code', 'Código', 'código interacional Alpha-2', TRUE);?>
								<? input_number($pais, 'contribucion_fija', 'Contribución fija', FALSE);?>									
							<br/>
							</fieldset>
