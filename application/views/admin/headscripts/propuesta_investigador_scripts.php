<script>
			...
			"render": function ( data, type, row ) {
                ...
                "render": function ( data, type, row ) {
					...
					return '<a href="javascript:accionModificarProd('+data+');" class="btn btn-link btn-warning btn-just-icon" title="Modificar" ><i class="material-icons">edit</i></a> &nbsp;'+
                           '<a href="javascript:accionEliminarProd('+data+');" class="btn btn-link btn-danger btn-just-icon" title="Eliminar" ><i class="material-icons">close</i></a> &nbsp;';
	...
	function accionEliminarProd(ideliminar){
		  swal({
                title: '¿Está Seguro?',
                text: "Está a punto de eliminar el producto",
                type: 'warning',
                showCancelButton: true,
                confirmButtonClass: 'btn btn-success',
                cancelButtonClass: 'btn btn-danger',
				...
				if (result.value) {
					$.post( "admin/productos/eliminar/<?=$idpropuesta?>", { "ideliminar": ideliminar })
						.done(function( data ) {
