   ...
   var table;
    $(document).ready(function(){
		options = {
          "sAjaxSource": "admin/usuarios/paginar/",
          "columnDefs": [
            {
                ...
                // this case `data: 0`.
                "render": function ( data, type, row ) {
                    return '<a href="admin/usuarios/ver/'+data+'" class="btn btn-link btn-info btn-just-icon" title="Ver" ><i class="material-icons">remove_red_eye</i></a> &nbsp;'+
                           '<a href="admin/usuarios/modificar/'+data+'"class="btn btn-link btn-warning btn-just-icon" title="Modificar" ><i class="material-icons">create</i></a> &nbsp;'+
      ...
      function accionEliminar(ideliminar){		  
		  swal({
                title: '¿Está Seguro?',
                text: "Está a punto de eliminar al usuario",
                type: 'warning',
				...
				if (result.value) {
					$.post( "admin/usuarios/eliminar", { "ideliminar": ideliminar })
						.done(function( data ) {
							table.ajax.reload();
							swal({
								title: '¡Eliminado!',
