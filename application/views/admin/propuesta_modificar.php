    ...
    <div class="container-fluid">
		...
		<div class="row">
            ...
            <div class="col-md-8 ml-auto mr-auto">
             	<div class="page-categories">
					...
					<ul class="nav nav-pills nav-pills-warning nav-pills-icons justify-content-center" role="tablist">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#linkDona" role="tablist">
								<i class="material-icons">assignment_turned_in</i> Donantes
							</a>
						</li>
						<li class="nav-item">
			...
			<div class="tab-content tab-space tab-subcategories col-md-12">
						...
						<div class="card-body ">
							...
							<?$disabled = empty($readonly)? '' : 'disabled' ?>
								<fieldset id="fieldset" <?=$disabled?> >
									...
									<div class="row">
										<label class="col-sm-2 col-form-label" for="idpropuesta">Perfil</label>
										<div class="col-sm-10">
											<div class="form-group">
												<select class="form-control" name="idperfil" id="idperfil">
												<?if(!empty($perfil)):?>
													<option value="<?=$perfil['idperfil']?>">ID:<?=$perfil['idperfil'].' - '.$perfil['titulo_corto'].')'?></option>													
												<?endif;?>
												</select>
											</div>
										</div>
									...
									<? input_lenguaje('hidden', $lenguajes, $datas_lang, 'plataforma', 'Plataforma');?>
									...
									<? input_select($propuesta, $solucion, 'solucion_tecnologica', 'Solución Tecnológica', TRUE);?>
									<? input_lenguaje('hidden', $lenguajes, $datas_lang, 'otras_agencias', 'Otras Agencias');?>
									<? /*input_select($propuesta, $rubros, 'idrubro', 'Rubro', TRUE);*/?>
									<? /*input_select($propuesta, $areas, 'idareainvestigacion', 'Área de Investigación', TRUE);*/?>									
									<div class="row">
										<label class="col-sm-2 col-form-label" for="idtemas">Temas</label>
										<div class="col-sm-10">
											<div class="form-group">
												<select class="selectpicker form-control alcien" name="idtemas[]" id="idtemas" multiple data-style="select-with-transition" data-live-search="true" title="Seleccione..." data-size="5">
													<option disabled> Opciones múltiples</option>
													<? foreach($temas as $opcion):?>
														<option value="<?=$opcion['id']?>" <?=(!empty($temasSelect[$opcion['id']]))?'SELECTED':''?> ><?=$opcion['nombre']?></option>
													<? endforeach;?>
												</select>
											</div>
										</div>
									...
									<? input_number($propuesta, 'plazo', 'Plazo de ejecucion (en meses)', FALSE);?>
									<? input_text('text', $propuesta, 'urlvieja', 'Url Vieja', 'Url del sistema viejo', false, 255)?>
									<br/><br/>
									
									<div class="form-group">
										Ingresar los valores solo si la propuesta no tiene ítems. Si a la propuesta se le agregan ítems, estos valores se sobre-escribiran con la sumatoria de los ítems: 
									</div>
									<fieldset id="fieldset2" disabled >
										<? input_number($propuesta, 'aporte_fontagro', 'Aporte FONTAGRO', FALSE);?>
										<? input_number($propuesta, 'aporte_bid', 'Aporte BID', FALSE);?>
										<? input_number($propuesta, 'movilizacion_agencias', 'Movilización de Otras Agencias', FALSE);?>
										<? input_number($propuesta, 'aporte_contrapartida', 'Aporte de Contrapartida', FALSE);?>
										<? input_number($propuesta, 'aporte_agencias', 'Aporte de O. Agencias', FALSE);?>
										<div class="row">
									...
									<br/>
									<hr/>
									<? input_text('text', $propuesta, 'web_url', 'Url', 'Url para ingresar a la web', true, 255)?>
									<? input_imagen($propuesta, 'web_foto', 'Imagen Principal - debe tener 1700 x 700 px. y no pesar más de 500KB', 'propuestas', false,'400_',true)?>
				...
				<div class="tab-pane" id="linkDona">				
					<div class="card">
						<div class="card-header card-header-rose card-header-icon">
							<div class="card-icon">
								<i class="material-icons">assignment_turned_in</i>
							</div>
							<h4 class="card-title">Principales donantes</h4>
							<p class="card-category" style="color:grey">&nbsp;</p>
						</div>
						<div class="card-body">
							<div class="toolbar" style="text-align:center; clear:both">
								<button onclick="abrirModalDonante()" class="btn btn-primary btn-round btn-fab" rel="tooltip" data-placement="bottom" title="Agregar Donante" >
									<i class="material-icons">add</i>
									<div class="ripple-container"></div>
								</button>	
							</div>

							<div class="material-datatables" id="tablaDonantes">
				...
				<div class="tab-pane" id="linkProd">				
					<div class="card">
						<div class="card-header card-header-rose card-header-icon">
							...
							<p class="card-category" style="color:grey"><br>
							En esta sección se suben los productos de conocimiento, los cuales se generan siguiendo alguno de estos formatos <a href="https://www.fontagro.org/es/productos-de-conocimiento/" style="color:black" target="_blank">https://www.fontagro.org/es/productos-de-conocimiento</a>
							<br>Cada uno de estos productos corresponder a un producto comprometido en la matriz de resultados del proyecto.
							<br>La STA y/o consultores externos, realizarán la lectura del mismo y remitirá al líder del proyecto en caso de necesitar ajustes.
							</p>
						</div>
						<div class="card-body">
							<div class="toolbar" style="text-align:center; clear:both">
                ...
                <div class="modal-body">
                    <form class="form" method="" action="">
                        ...
                        <div class="card-body">
							...
							<? modal_input_text('url', 'urlold', 'adj', 'account_box', 'Url', 'Url', 255); ?>
							...
							<div class="form-group bmd-form-group">
                                <div class="input-group">
									...
									<select class="selectpicker selectCopado" id="adj_habilitado" data-style="select-with-transition" title="Estado?" data-size="2">
