        	...
        	<div class="col-md-12">
				<div class="card ">
					<div class="card-header card-header-rose card-header-icon">
						...
						<h4 class="card-title"><?=(!empty($parametro))?'Modificar':'Crear'?> <?=$Parametro?></h4>
                	...
                	<div class="card-body ">
						<div class="nav-item dropdown opciones-toolbar" style="">	
							...
							<div class="dropdown-menu">
								<a class="dropdown-item dropdown-item-rose" href="admin/parametros/listar/<?=$Parametro?>">Listar <?=$Parametro?></a>
							</div>
						</div>
